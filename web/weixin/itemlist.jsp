...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#grid').datagrid({
                toolbar: toolbar,
                url: "/weixinmanager/getItemList.do",
                method: "GET",
                columns: columns,
                ...
                onLoadSuccess:function(data){
                    ...
                    $('td[field="xx"]').mousemove(function () {
                        ...
                        var self = this;
                        $(this).children('div').children('a').attr('href',"javascript:testAddSubPage('商品规格模板设置','/weixin/ggcsvaluelist.jsp?id="+index+"')");
                    });
