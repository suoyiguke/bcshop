...
<!-- 
			...
			<div class="footer-grids">
				<div class="col-md-3 footer-grid wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
					...
					<div class="footer-grd-left">
						<img src="<%=basePath%>images/6.jpg" class="img-responsive" alt=" " />
					</div>
					<div class="footer-grd-left">
				...
				<div class="col-md-3 footer-grid wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
					...
					<div class="footer-grd">
						<a href="#"><img src="<%=basePath%>images/7.jpg" class="img-responsive" alt=" " /></a>
					</div>
					<div class="footer-grd">
						<a href="#"><img src="<%=basePath%>images/8.jpg" class="img-responsive" alt=" " /></a>
					</div>
					<div class="footer-grd">
						<a href="#"><img src="<%=basePath%>images/7.jpg" class="img-responsive" alt=" " /></a>
					</div>
	...
	<div class="footer-bottom wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
		<div class="container">
			<p>Copyright &copy; 2018.Meiri Furniture All rights reserved.</p>
		</div>
	</div>
<!-- //footer -->