...
<!-- single -->
	...
	<div class="container">
		...
		<div class="wow fadeInLeftBig" data-wow-duration="1000ms" data-wow-delay="300ms">
			<p>Published on <span>${news.publishdate }</span></p>
		</div>
		...
		<div>
		 <iframe width="100%" id="commentFrame" frameborder="0" src="<%=basePath%>comment/view.do?objId=${news.id}&type=w_news">
		 </iframe>
		</div>
	</div>
	</div>
