...
<![endif]-->
<link rel="stylesheet" type="text/css" href="<%=basePath%>js/workflow/GooFlow2.css"/>
<!--<link rel="stylesheet" type="text/css" href="js/workflow/GooFlow.css"/>-->
<style>
...
<script type="text/javascript" src="<%=basePath%>js/workflow/jquery.min.js"></script>
<script type="text/javascript" src="<%=basePath%>js/workflow/GooFunc.js"></script>
<script type="text/javascript" src="<%=basePath%>js/workflow/json2.js"></script>
<link rel="stylesheet" type="text/css" href="<%=basePath%>js/workflow/default.css"/>
<script type="text/javascript" src="<%=basePath%>js/workflow/GooFlow.js"></script>
<script type="text/javascript" src="<%=basePath%>js/workflow/GooFlow_color.js"></script>
...
$(document).ready(function(){
	...
	$.ajax({
        type: "post",
        async:false,
        url: "<%=basePath%>workflowChart/getJson.do",
        data: {pipeId:"${requestScope.pipeId}"},
        dataType: "json",
