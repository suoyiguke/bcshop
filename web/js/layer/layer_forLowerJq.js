...
function(a, b) {
    ...
    g.pt.creat = function() {
        ...
        if (!c("#" + b.id)[0]) {
            ...
            c(document).unbind("keydown", e.enter).bind("keydown", e.enter),
            a.layero.bind("keydown",
            function(a) {
                c(document).unbind("keydown", e.enter)
            }),
    ...
    g.pt.callback = function() {
        ...
        g = b.config;
        b.openLayer(),
        g.success && (2 == g.type ? d.find("iframe").bind("load",
        function() {
            g.success(d, b.index)
        }) : g.success(d, b.index)),
        f.ie6 && b.IE6(d),
        d.find("." + h[6]).children("a").bind("click",
        function() {
            var a = c(this).index();
        ...
        d.find("." + h[7]).bind("click", a),
        g.shadeClose && c("#layui-layer-shade" + b.index).bind("click",
        function() {
            f.close(b.index)
        }),
        d.find(".layui-layer-min").bind("click",
        function() {
            f.min(b.index, g),
            g.min && g.min(d)
        }),
        d.find(".layui-layer-max").bind("click",
        function() {
    ...
    f.photos = function(b, d, e) {
        ...
        b.photos) {
            ...
            h.event = function() {
                ...
                h.bigimg.find(".layui-layer-imgprev").bind("click",
                function(a) {
                    a.preventDefault(),
                    h.imgprev()
                }),
                h.bigimg.find(".layui-layer-imgnext").bind("click",
                function(a) {
                    a.preventDefault(),
                    h.imgnext()
                }),
                c(document).bind("keyup", h.keyup)
            },
            h.loadi = f.load(1, {
            ...
            function(d) {
                ...
                h.index = f.open(c.extend({
                    ...
                    success: function(a, c) {
                        ...
                        h.end = !0,
                        c(document).unbind("keyup", h.keyup)
                    }
                },
                b))
            },
