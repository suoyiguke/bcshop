...
KindEditor.plugin('emoticons', function (K) {
    ...
    self.clickToolbar(name, function () {
        ...
        initImgBox(faceBox['tab7'], 'm_00', 8);
        ...
        inforBox['tab7'] = ['扭屁股', '生气', '吵架', '呵呵', '吹气球', '踢球', '吃爆米花', '窃喜'];
        inforBox['tab8'] = ['扭屁股', '生气'];
        //大对象
        FaceHandler = {
            imageFolders: { tab0: 'jx2/', tab1: 'tsj/', tab2: 'ldw/', tab3: 'bobo/', tab4: 'babycat/', tab5: 'face/', tab6: 'youa/',tab7: 'minions/' },
            ...
            imageCss: { tab0: 'jd', tab1: 'tsj', tab2: 'ldw', tab3: 'bb', tab4: 'cat', tab5: 'pp', tab6: 'youa',tab7: 'mini' },
